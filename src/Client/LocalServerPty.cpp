...
// void LocalServerPty::initialize(Poco::Util::Application & self)
// {
...
void LocalServerPty::tryInitPath()
{
    std::string path;
...
std::string LocalServerPty::getInitialCreateTableQuery()
{
...
void LocalServerPty::setupUsers()
{
...
void LocalServerPty::updateLoggerLevel(const String & logs_level)
{
...
void LocalServerPty::addOptions(OptionsDescription & options_description)
{
...
void LocalServerPty::applyCmdSettings(ContextMutablePtr context)
{
    context->applySettingsChanges(cmd_settings.changes());
}


void LocalServerPty::applyCmdOptions(ContextMutablePtr context)
{
...
void LocalServerPty::processOptions(const OptionsDescription &, const CommandLineOptions & options, const std::vector<Arguments> &, const std::vector<Arguments> &)
{
